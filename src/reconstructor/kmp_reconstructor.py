...
class KMPReconstructor:
    ...
    def reconstruct(self, reads_file: str) -> np.ndarray:
        ...
        # 재구성된 시퀀스 저장
        save_reconstructed_sequence(reconstructed, reads_file, "kmp")
...
if __name__ == "__main__":
    ...
    reconstructor.reconstruct("data/reads/sequence_10000bp_reads_100bp.bin")
    end_time = time.time()
    
    print(f"\n실행 시간: {end_time - start_time:.2f}초")
    
    original_file = "data/original/sequence_10000bp.bin"
    reconstructed_file = "data/reconstructed/kmp_sequence_10000bp_reads_100bp.bin"
